...
# proxy
alias set_all_proxy="export ALL_PROXY=\"socks5://127.0.0.1:7891\""

# 设置setproxy和unsetproxy 可以快捷的开关
# 需要时先输入命令 setproxy
# 不需要时输入命令 unsetproxy
alias set_proxy="export http_proxy=\"http://127.0.0.1:7890\"; export https_proxy=\"http://localhost:7890\"; echo 'HTTP Proxy on';"
alias unsetproxy="unset http_proxy; unset https_proxy; echo 'HTTP Proxy off';"
alias print_proxy="echo http_proxy=$http_proxy&&echo https_proxy=$https_proxy"
